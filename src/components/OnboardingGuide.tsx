        ...
        >
          ...
          <div className="flex items-center justify-between gap-2 pt-1">
              ...
              {steps.map((_, i) => (
                <span
                  ...
                  className={`h-1.5 rounded-full transition-all ${
                    i === step ? 'w-3 bg-primary' : 'w-1.5 bg-surface-container-high'
                  }`}
                />
              ))}
            </div>
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <button
                onClick={next}
                className="inline-flex items-center gap-1 px-3 py-2 rounded-xl bg-primary text-white font-mono text-[11px] font-bold uppercase tracking-wider hover:bg-ink transition-colors cursor-pointer border-none whitespace-nowrap shrink-0"
              >
